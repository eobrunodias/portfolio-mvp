...
const projects = [
  {
    ...
    description:
      "Plataforma de e-commerce completa com autenticação, carrinho de compras e pagamento.",
  ...
  },
  {
    ...
    title: "Blog Pessoal",
    description:
      "Blog minimalista com sistema de comentários e markdown support.",
  ...
  },
  {
    ...
    description:
      "Aplicativo de gestão de tarefas com sincronização em tempo real.",
